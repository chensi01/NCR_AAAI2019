function out = MF(seed,rawData,file_folder,varargin)
rng(seed);
%% Parse parameters
params = inputParser;
...
for i = 1:cvObj.NumTestSets
    ...
    filename_1 = sprintf('MF_fold_%i.mat',i);
...
result = sprintf('MF Final Results: AUC = %f, NDCG = %f,MRR = %f \n',mean(out));
filename = fullfile(file_folder,'MF_baseline_final_result.mat');
